...
START_TEST(s21_sin_test_1) {
  ...
  ck_assert_ldouble_nan(s21_sin(test_var_1));
  ck_assert_ldouble_nan(sin(test_var_1));
}
END_TEST
...
START_TEST(s21_sin_test_4) {
  ...
  ck_assert_ldouble_eq_tol(s21_sin(test_var_1), sin(test_var_1), ERROR);
}
END_TEST
...
START_TEST(s21_sin_test_12) {
  for (double test_var_1 = -S21_PI; test_var_1 <= S21_PI;
...
Suite *suite(void) {
  ...
  tcase_add_test(tcase, s21_sin_test_1);
  tcase_add_test(tcase, s21_sin_test_2);
  tcase_add_test(tcase, s21_sin_test_3);
  tcase_add_test(tcase, s21_sin_test_4);
  tcase_add_test(tcase, s21_sin_test_5);
  tcase_add_test(tcase, s21_sin_test_6);
  tcase_add_test(tcase, s21_sin_test_7);
  tcase_add_test(tcase, s21_sin_test_8);
  tcase_add_test(tcase, s21_sin_test_9);
  tcase_add_test(tcase, s21_sin_test_10);
  tcase_add_test(tcase, s21_sin_test_11);
  tcase_add_test(tcase, s21_sin_test_12);

...
START_TEST(is_greater_or_equal_1) {
  ...
  ck_assert_int_eq(s21_is_greater_or_equal(number1, number1), 1);
  ck_assert_int_eq(s21_is_greater_or_equal(number1, number3), 0);
  ck_assert_int_eq(s21_is_greater_or_equal(number6, number3), 1);
  ck_assert_int_eq(s21_is_greater_or_equal(number3, number1), 1);
  ck_assert_int_eq(s21_is_greater_or_equal(number3, number6), 0);
  ck_assert_int_eq(s21_is_greater_or_equal(number3, number3), 1);
  ck_assert_int_eq(s21_is_greater_or_equal(number2, number4), 1);
  ck_assert_int_eq(s21_is_greater_or_equal(number1, number5), 0);
  ck_assert_int_eq(s21_is_greater_or_equal(number5, number6), 0);
}
END_TEST

Suite *suite(void) {
  Suite *suite = suite_create("\033[45m-=S21_IS_GREATER_OR_EQUAL=-\033[0m");

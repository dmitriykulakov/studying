...
START_TEST(is_less_1) {
  ...
  ck_assert_int_eq(s21_is_less(number1, number1), 0);
  ck_assert_int_eq(s21_is_less(number1, number3), 1);
  ck_assert_int_eq(s21_is_less(number6, number3), 0);
  ck_assert_int_eq(s21_is_less(number3, number1), 0);
  ck_assert_int_eq(s21_is_less(number3, number6), 1);
  ck_assert_int_eq(s21_is_less(number3, number3), 0);
  ck_assert_int_eq(s21_is_less(number2, number4), 0);
  ck_assert_int_eq(s21_is_less(number1, number5), 1);
  ck_assert_int_eq(s21_is_less(number5, number6), 1);
}
END_TEST

Suite *suite(void) {
  Suite *suite = suite_create("\033[45m-=S21_IS_LESS=-\033[0m");

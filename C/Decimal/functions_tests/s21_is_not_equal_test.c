...
START_TEST(is_not_equal_1) {
  ...
  ck_assert_int_eq(s21_is_not_equal(number1, number1), 0);
  ck_assert_int_eq(s21_is_not_equal(number3, number3), 0);
  ck_assert_int_eq(s21_is_not_equal(number2, number4), 1);
  ck_assert_int_eq(s21_is_not_equal(number1, number5), 1);
  ck_assert_int_eq(s21_is_not_equal(number5, number6), 1);
}
END_TEST

Suite *suite(void) {
  Suite *suite = suite_create("\033[45m-=S21_IS_NOT_EQUAL=-\033[0m");

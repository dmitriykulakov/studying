...
START_TEST(s21_floor_test_1) {
  ...
  ck_assert_int_eq(s21_floor(test_var_1, NULL), RETURN_VALUE_1);
}
END_TEST
...
START_TEST(s21_floor_test_2) {
  ...
  ck_assert_int_eq(s21_floor(test_var_1, &test_var_2), RETURN_VALUE_0);
...
START_TEST(s21_floor_test_7) {
  ...
  ck_assert_int_eq(s21_floor(test_var_1, &test_var_2), RETURN_VALUE_0);
  ck_assert_uint_eq((unsigned int)test_var_2.bits[0], 124);
  ck_assert_uint_eq((unsigned int)test_var_2.bits[3], 0x80000000);
}
END_TEST
...
START_TEST(s21_floor_test_9) {
  ...
  ck_assert_int_eq(s21_floor(test_var_1, &test_var_2), RETURN_VALUE_0);
  ck_assert_uint_eq((unsigned int)test_var_2.bits[0], 1);
  ck_assert_uint_eq((unsigned int)test_var_2.bits[3], 0x80000000);
}
END_TEST
...
START_TEST(s21_floor_test_18) {
  ...
  ck_assert_int_eq(s21_floor(test_var_1, &test_var_2), RETURN_VALUE_0);
  ck_assert_uint_eq((unsigned int)test_var_2.bits[0], 0xffffffff);
  ck_assert_uint_eq((unsigned int)test_var_2.bits[1], 0x00000000);

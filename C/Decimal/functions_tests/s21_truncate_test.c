...
START_TEST(s21_truncate_test_1) {
  ...
  ck_assert_int_eq(s21_truncate(test_var_1, NULL), RETURN_VALUE_1);
}
END_TEST
...
START_TEST(s21_truncate_test_2) {
  ...
  ck_assert_int_eq(s21_truncate(test_var_1, &test_var_2), RETURN_VALUE_0);
...
START_TEST(s21_truncate_test_6) {
  ...
  ck_assert_int_eq(s21_truncate(test_var_1, &test_var_2), RETURN_VALUE_0);
  ck_assert_uint_eq((unsigned int)test_var_2.bits[0], 123450);
  ck_assert_uint_eq((unsigned int)test_var_2.bits[3], 0x00000000);
}
END_TEST
...
START_TEST(s21_truncate_test_8) {
  ...
  test_var_1.bits[0] = 1234500000;
  test_var_1.bits[1] = 0;
  test_var_1.bits[2] = 0;
  test_var_1.bits[3] = 0x00000000;

  ck_assert_int_eq(s21_truncate(test_var_1, &test_var_2), RETURN_VALUE_0);
  ck_assert_uint_eq((unsigned int)test_var_2.bits[0], 1234500000);
  ck_assert_uint_eq((unsigned int)test_var_2.bits[3], 0x00000000);
}
END_TEST
...
START_TEST(s21_truncate_test_12) {
  ...
  ck_assert_int_eq(s21_truncate(test_var_1, &test_var_2), RETURN_VALUE_0);
  ck_assert_uint_eq((unsigned int)test_var_2.bits[0], 1234);
  ck_assert_uint_eq((unsigned int)test_var_2.bits[3], 0x00000000);
}
END_TEST
...
START_TEST(s21_truncate_test_18) {
  ...
  ck_assert_int_eq(s21_truncate(test_var_1, &test_var_2), RETURN_VALUE_0);
  ck_assert_uint_eq((unsigned int)test_var_2.bits[0], 0x8F5C28F5);
...
Suite *suite(void) {
  Suite *suite = suite_create("\033[32m s21_truncate_test \033[0m");
  ...
  tcase_add_test(tcase, s21_truncate_test_12);
  tcase_add_test(tcase, s21_truncate_test_13);
  tcase_add_test(tcase, s21_truncate_test_14);
  tcase_add_test(tcase, s21_truncate_test_15);
  tcase_add_test(tcase, s21_truncate_test_16);
  tcase_add_test(tcase, s21_truncate_test_17);
  tcase_add_test(tcase, s21_truncate_test_18);
  tcase_add_test(tcase, s21_truncate_test_19);
